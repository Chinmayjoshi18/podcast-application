...
-- AddForeignKey
ALTER TABLE "_PodcastTags" ADD CONSTRAINT "_PodcastTags_A_fkey" FOREIGN KEY ("A") REFERENCES "Podcast"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "_PodcastTags" ADD CONSTRAINT "_PodcastTags_B_fkey" FOREIGN KEY ("B") REFERENCES "Tag"("id") ON DELETE CASCADE ON UPDATE CASCADE;
